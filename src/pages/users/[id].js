...
function UserPage() {
  ...
  const {
    ...
    variables: {
      id: "0x26053dbbb42292c715c8405511d3eb9e5da032a7",
    },
  });
  ...
  return (
    <AppShell>
      <Head>
        <title>User {id} | RegoSwap Analytics</title>
      </Head>
                  ...
                  <TableRow key="12">
                    <TableCell component="th" scope="row">
                      <Box display="flex" alignItems="center">
                        ...
                        {/* <Link href={`/tokens/0x00eabc1d044764cc9e959954698426326247b1c4`} variant="body2" noWrap>
                        xSUSHI
                      </Link> */}
                      </Box>
                    </TableCell>
